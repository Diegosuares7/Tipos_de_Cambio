import { BcraRealBrasilHandlerService } from '../bcra-real-brasil-handler.service';

describe('BcraRealBrasilHandlerService', () => {
  let bcraRealBrasilHandlerService: BcraRealBrasilHandlerService;

  beforeEach(() => {
    bcraRealBrasilHandlerService = new BcraRealBrasilHandlerService();
  });

  it('should return currency data', async () => {
    const currencyData = await bcraRealBrasilHandlerService.getCurrencyData();
