import { BcbPesoUruguayoHandlerService } from '../bcb-peso-uruguayo-handler.service';

describe('BcbPesoUruguayoHandlerService', () => {
  let bcbPesoUruguayoHandlerService: BcbPesoUruguayoHandlerService;

  beforeEach(() => {
    bcbPesoUruguayoHandlerService = new BcbPesoUruguayoHandlerService();
  });

  it('should return currency data', async () => {
    const currencyData = await bcbPesoUruguayoHandlerService.getCurrencyData();
