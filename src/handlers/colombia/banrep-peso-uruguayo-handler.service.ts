...
import { COLOMBIA_BANREP_PESO_URUGUAYO } from '../../utiles/const-coins';
...
export class BanrepPesoUruguayoHandlerService implements CurrencyHandler {
  async getCurrencyData(): Promise<CurrencyProcess> {
    try {
      ...
      return handleProcessError(error.message, 'BanrepPesoUruguayoHandlerService');
    }
  }
}
