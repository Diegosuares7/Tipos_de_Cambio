...
import { COLOMBIA_BANREP_GENERAL, COLOMBIA_BANREP_PESO_MEXICANO } from '../../utiles/const-coins';
...
export class BanrepPesoMexicanoHandlerService implements CurrencyHandler {
  async getCurrencyData(): Promise<CurrencyProcess> {
    try {
      ...
      return handleProcessError(error.message, 'BanrepPesoMexicanoHandlerService');
    }
  }
}
