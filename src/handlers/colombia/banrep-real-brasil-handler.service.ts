...
import { COLOMBIA_BANREP_GENERAL, COLOMBIA_BANREP_REAL_BRASIL } from '../../utiles/const-coins';
...
export class BanrepRealBrasilHandlerService implements CurrencyHandler {
  async getCurrencyData(): Promise<CurrencyProcess> {
    try {
      ...
      return handleProcessError(error.message, 'BanrepRealBrasilHandlerService');
    }
  }
}
