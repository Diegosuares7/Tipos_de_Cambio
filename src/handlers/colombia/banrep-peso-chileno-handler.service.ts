...
import { COLOMBIA_BANREP_PESO_CHILENO } from '../../utiles/const-coins';
...
export class BanrepPesoChilenoHandlerService implements CurrencyHandler {
  async getCurrencyData(): Promise<CurrencyProcess> {
    try {
      ...
      return handleProcessError(error.message, 'BanrepPesoChilenoHandlerService');
    }
  }
}
