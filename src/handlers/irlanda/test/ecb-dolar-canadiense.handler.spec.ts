import { EcbDolarCanadienseHandlerService } from '../ecb-dolar-canadiense-handler.service';

describe('EcbDolarCanadienseHandlerService', () => {
  let ecbHandlerService: EcbDolarCanadienseHandlerService;

  beforeEach(() => {
    ecbHandlerService = new EcbDolarCanadienseHandlerService();
  });
